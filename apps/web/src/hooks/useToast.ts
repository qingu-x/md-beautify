...
export const toast = {
  ...
  promise: <T>(p: Promise<T>, msgs: any) => toastInstance.promise(p, msgs),
  update: (id: number, updates: any) => toastInstance.updateToast(id, updates),
  remove: (id: number) => toastInstance.removeToast(id),
};
