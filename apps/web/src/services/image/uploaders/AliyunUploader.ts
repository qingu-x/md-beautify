...
/**
 * Aliyun OSS Image Host / 阿里云 OSS 图床
 * Official Site: https://www.aliyun.com/product/oss / 官网：https://www.aliyun.com/product/oss
 */
export class AliyunUploader implements ImageUploader {
  get name() {
    return t("imageHost.tabs.aliyun");
  }
  ...
  async validate(): Promise<boolean> {
    try {
      ...
      // Try to upload a test file to validate config / 尝试上传一个测试文件来验证配置
